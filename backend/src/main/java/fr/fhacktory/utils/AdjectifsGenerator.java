...
public class AdjectifsGenerator {
	...
	private static final List<String> objectsAdj = Arrays.asList("argenté", "azuré ", "blanc", "bleu ", "blond", "brun",
			"châtain", "cyan ", "grenat", "magenta", "marron", "noir ", "orange", "pourpré", "rose ", "roux",
			"turquoise", "vert ", "violet", "colossal", "considérable", "énorme", "exigu exiguë", "fin", "gigantesque",
			"grand ", "immense", "important", "imposant", "infime", "large ", "menu", "minuscule ", "monumental",
			"petit ", "spacieux", "super féminin", "vaste", "altéré ", "carré ", "circulaire ", "creux", "décomposé",
			"déformé", "droit", "étroit ", "géométrique", "large ", "long longue", "maigre ", "plat ", "primitif",
			"raide ", "rectangulaire", "rond", "simple", "tordu ", "triangulaire", "vaste", "abondant", "bienfaisant",
			"chargé", "compact", "considérable", "dense", "écrasant", "énorme", "extra féminin", "fréquent", "généreux",
			"gros", "illimité", "incalculable", "innombrable", "léger", "lourd", "multiple", "nombreux", "rempli",
			"substantiel", "répété", "vide", "volumineux");
